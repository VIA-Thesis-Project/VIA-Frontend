...
export default function NewEvaluation({ navigate }: Props) {
  ...
  const [selectedCrops, setSelectedCrops] = useState<string[]>(['Camote', 'Maíz', 'Tomate']);
        ...
        <div style={{ flex: 1, display: 'grid', gridTemplateColumns: '380px 1fr', gap: 0, minHeight: 0 }}>
          ...
          <div style={{ background: 'white', borderRight: '1px solid #f1f5f9', overflowY: 'auto', padding: '24px 24px' }}>
            ...
            <div style={{ marginBottom: 24 }}>
              ...
              <div style={{ fontSize: 11.5, color: '#94a3b8', marginTop: 8 }}>Seleccionados: {selectedCrops.join(', ') || 'ninguno'}</div>
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              ...
              <button
                ...
                style={{ background: '#16a34a', color: 'white', border: 'none', padding: '12px', borderRadius: 10, fontSize: 14, fontWeight: 600, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}
              >
                Procesar variables agroambientales
